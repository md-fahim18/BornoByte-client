...
const CourseDetail = () => {
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-10">
      {/* Course Title */}
      <h1 className="text-4xl font-bold text-neutral-800 dark:text-neutral-100 mb-6 text-center lg:text-left">
      ...
      <div className="mt-12 space-y-10">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3">
            Course Overview text-neutral-800 dark:text-neutral-100
          </h2>
        ...
        <div>
          ...
          <ul className="list-disc ml-5 space-y-2 text-neutral-800 dark:text-neutral-100 leading-relaxed">
